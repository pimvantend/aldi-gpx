...
def verwerkpostcodech(postcode,land1):
	...
	mapaanvraag='https://www.hofer.si/poslovalnice/sl-si/Search?SingleSlotGeo='+postcode
	gewenst='Hofer'
	nietgewenst='ALDI'
    elif land1=='hu':
	mapaanvraag='https://www.aldi.hu/uzletek/hu-hu/Search?SingleSlotGeo='+postcode
	gewenst='ALDI'
	nietgewenst='Hofer'
    time.sleep(3)
    print mapaanvraag
...
land1='hu'
picklebestandsnaam='aldihu.pickle'
